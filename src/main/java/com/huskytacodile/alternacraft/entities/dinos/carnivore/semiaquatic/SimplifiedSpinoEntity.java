...
public class SimplifiedSpinoEntity extends SemiAquaticEntity {
    public SimplifiedSpinoEntity(EntityType<? extends TamableAnimal> p_i48575_1_, Level p_i48575_2_) {
    ...
    @Nullable
    @Override
    public SimplifiedSpinoEntity getBreedOffspring(ServerLevel serverLevel, AgeableMob p_146744_) {
        return ModEntityTypes.SIMPLIFIED_SPINO.get().create(serverLevel);
    }
}