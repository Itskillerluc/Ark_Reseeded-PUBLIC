...
public class BaryMeleeAttackGoal extends MeleeAttackGoal {
    private CarnivoreEntity entity;
    private int animCounter = 0;
    private double animTickLength = 58.3334;

    public BaryMeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
