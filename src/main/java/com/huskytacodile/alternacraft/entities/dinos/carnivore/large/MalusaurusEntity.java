...
public class MalusaurusEntity extends LargeCarnivoreEntity {
    public MalusaurusEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MalusaurusMeleeAttackGoal(this, 1.2, false));
