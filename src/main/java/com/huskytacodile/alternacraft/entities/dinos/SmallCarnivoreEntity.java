...
public abstract class SmallCarnivoreEntity extends AlternaNonRideableDinoEntity {
    ...
    protected static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(SmallCarnivoreEntity.class, EntityDataSerializers.BOOLEAN);
