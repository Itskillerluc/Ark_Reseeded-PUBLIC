...
public class FossilGrinderMenu extends AbstractContainerMenu {
    private final FossilGrinderBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FossilGrinderMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FOSSIL_GRINDER.get());
    }
