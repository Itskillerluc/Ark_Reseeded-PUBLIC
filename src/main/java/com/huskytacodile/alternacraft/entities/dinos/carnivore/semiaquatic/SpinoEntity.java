...
public class SpinoEntity extends SemiAquaticEntity {
    public SpinoEntity(EntityType<? extends TamableAnimal> p_i48575_1_, Level p_i48575_2_) {
    ...
    {
        return this.isAsleep() ? null : ModSoundEvents.RSPINO_AMBIENT.get();
    }

    @Override
    protected SoundEvent getDeathSound()
    {
        return ModSoundEvents.RSPINO_DEATH.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn)
    {
        return ModSoundEvents.RSPINO_HURT.get();
    }
