...
public class GigaEntity extends LargeCarnivoreEntity {
    public GigaEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    {
        return this.isAsleep() ? null : ModSoundEvents.GIGA_AMBIENT.get();
    }
