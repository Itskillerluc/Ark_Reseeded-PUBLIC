...
public class SuchomimusEntity extends SemiAquaticEntity {
    public SuchomimusEntity(EntityType<? extends TamableAnimal> p_i48575_1_, Level p_i48575_2_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new OxalaiaMeleeAttackGoal(this, 1.2, false));
    ...
    {
        return this.isAsleep() ? null : ModSoundEvents.SPINOSAURUS_IDLE_ROAR.get();
    }

    @Override
    protected SoundEvent getDeathSound()
    {
        return ModSoundEvents.SPINOSAURUS_DEATH.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn)
    {
        return ModSoundEvents.SPINOSAURUS_HURT.get();
    }
