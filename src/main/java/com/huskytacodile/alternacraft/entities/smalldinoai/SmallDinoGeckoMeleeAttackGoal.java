...
public class SmallDinoGeckoMeleeAttackGoal extends MeleeAttackGoal {
    private SmallCarnivoreEntity entity;
    private int animCounter = 0;
    private int animTickLength = 12;

    public SmallDinoGeckoMeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
