...
public class BaryonyxGen2Entity extends SemiAquaticEntity {
    public BaryonyxGen2Entity(EntityType<? extends TamableAnimal> p_i48575_1_, Level p_i48575_2_) {
    ...
    {
        return this.isAsleep() ? null : ModSoundEvents.BARY_AMBIENT.get();
    }
