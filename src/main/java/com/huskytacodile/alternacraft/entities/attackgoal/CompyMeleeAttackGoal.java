...
public class CompyMeleeAttackGoal extends MeleeAttackGoal {
    private SmallCarnivoreEntity entity;
    private int animCounter = 0;
    private double animTickLength = 43.3334;

    public CompyMeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
