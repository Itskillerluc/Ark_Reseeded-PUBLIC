...
public class IndoGen1MeleeAttackGoal extends MeleeAttackGoal {
    private CarnivoreEntity entity;
    private int animCounter = 0;
    private double animTickLength = 24.1666;


    public IndoGen1MeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
