...
public class CeratosuchopsEntity extends SemiAquaticEntity {
    public CeratosuchopsEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    {
        return this.isAsleep() ? null : ModSoundEvents.CERATOSUCHOPS_IDLE_ROAR.get();
    }

    @Override
    protected SoundEvent getDeathSound()
    {
        return ModSoundEvents.CERATOSUCHOPS_DEATH.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn)
    {
        return ModSoundEvents.CERATOSUCHOPS_HURT.get();
    }

    @Override
    public String getAnimationName() {
        return "ceratosuchops";
    }

    @Nullable
    @Override
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob mageableMob) {
        return null;
    }
}