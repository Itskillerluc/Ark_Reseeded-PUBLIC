...
public class DryptoMeleeAttackGoal extends MeleeAttackGoal {
    private CarnivoreEntity entity;
    private int animCounter = 0;
    private double animTickLength = 16.6666;

    public DryptoMeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
